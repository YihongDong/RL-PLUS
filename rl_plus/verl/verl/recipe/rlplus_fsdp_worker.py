...
class RLPlusActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self):
        ...
        if self.config.rollout.name == 'hf':
            ...
            from .rlplus_vllm_rollout import RLPlusvLLMRollout
            from verl.workers.sharding_manager import FSDPVLLMShardingManager
            log_gpu_memory_usage('Before building vllm rollout', logger=None)
            rollout = RLPlusvLLMRollout(actor_module=self.actor_module_fsdp,
    ...
    def init_model(self):
        ...
        if self._is_actor:
            ...
            from .rlplus_actor import RLPlusDataParallelPPOActor
            self.actor = RLPlusDataParallelPPOActor(config=self.config.actor,
