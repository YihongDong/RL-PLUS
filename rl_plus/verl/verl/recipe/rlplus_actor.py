...
__all__ = ['RLPlusDataParallelPPOActor']

from verl.workers.actor.dp_actor import DataParallelPPOActor

class RLPlusDataParallelPPOActor(DataParallelPPOActor):
    def __init__(
        self,
        config,
            ...
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if self.config.use_sft_multitask_loss:
                        ...
                        from .rlplus_core_alg import compute_sft_pure_loss
                        ...
                        from .rlplus_core_alg import compute_token_on_off_policy_loss
                        ...
                        ret_dict = loss_fn(old_log_prob=old_log_prob, 
                            ...
                            off_policy_strategy=self.config.off_policy_strategy,
