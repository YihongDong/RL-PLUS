...
ROOT=/mnt/nas-coai-wlcb-202403/dongyh/OurCode/RL-PLUS
...
export MODEL_PATH=/mnt/nas-coai-wlcb-202403/jiangxue/LLMs/Qwen2.5-Math-7B-16k-think
...
cd $ROOT/rl_plus/verl/

# Train over a single node, 8 A100-80GB GPUs.
python3 -m verl.recipe.main_rlplus_ppo \
    ...
    trainer.total_epochs=30 $@ 2>&1 | tee ${LOG_PATH}
